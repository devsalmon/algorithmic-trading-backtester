...
class PortfolioConstructor():
    def __init__(self, trades):
        ...
        for trade in trades:
            utid, ticker, qty, buy_date, sell_date = trade
            df[ticker].loc[buy_date:sell_date] = qty
...
# UTID:  Ticker:  Quantity:  Buy Date:  Sell Date:
trades = [
    [1, "AAPL", 10, dt.date(2013,1,4), dt.date(2013,1,8)],
    [3, "MSFT", 10, dt.date(2013,1,3), dt.date(2013,1,5)],
    [4, "AAPL", 10, dt.date(2013,1,8), dt.date(2013,1,14)],
    [2, "GBPUSD=X", 10, dt.date(2013,1,2), dt.date(2013,1,4)]
    ]
