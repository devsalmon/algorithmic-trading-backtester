...
test_strategy_4 = TestStrategy4("GLD", dt.date(2018, 1, 2), dt.date(2020, 1, 3))
...
graph = GraphicalConstructor(
    trades_list, strategy_portfolio, indicator_df, ["Adj Close", "MA1", "MA2"]
)
